...
@singleton()
export class AdvnService extends AbstractTokenFetcherService {
    public async getTokens(start: number): Promise<AdvnGeneralResponse> {
    ...
    public async getTokenInfo(id: string): Promise<string> {
        return this.loadPageContent(`https://www.advfn.com/crypto/${id}/fundamentals`)
    }
}
